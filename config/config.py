...
class RAGConfig(BaseModel):
    ...
    pg_connection_string: str = Field(default=os.getenv("PG_CONNECTION_STRING"),
    ...
    vanna_doc: str = Field(default=os.getenv("MILVUS_COLLECTION_DOC_NAME", "danwen_doc"),
                           description="Milvus collection name")
    vanna_ddl: str = Field(default=os.getenv("MILVUS_COLLECTION_DDL_NAME", "danwen_ddl"),
                           description="Milvus collection name")
    vanna_sql: str = Field(default=os.getenv("MILVUS_COLLECTION_SQL_NAME", "danwen_sql"),
                           description="Milvus collection name")
    ...
    pg_host: str = Field(default=os.getenv("PG_HOST"), description="MySQL host")
    pg_user: str = Field(default=os.getenv("PG_USER"), description="MySQL user")
    pg_password: str = Field(default=os.getenv("PG_PASSWORD"), description="MySQL password")
    pg_db: str = Field(default=os.getenv("PG_DB"), description="MySQL database")
    pg_port: int = Field(default=os.getenv("PG_PORT"), description="MySQL port")
