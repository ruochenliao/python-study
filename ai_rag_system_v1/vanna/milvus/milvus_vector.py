...
class Milvus_VectorStore(VannaBase):
    ...
    def __init__(self, config=None):
        ...
        if config:
            self.vannasql = config.get("sql_collection_name", "danwen_sql")
            self.vannaddl = config.get("ddl_collection_name", "danwen_ddl")
            self.vannadoc = config.get("doc_collection_name", "danwen_doc")
        else:
            self.vannasql = "danwen_sql"
            self.vannaddl = "danwen_ddl"
            self.vannadoc = "danwen_doc"
