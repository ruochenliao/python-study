...
class RAGConfig(BaseModel):
    ...
    deepseek_api_key: str = Field(default=os.getenv("DEEPSEEK_API_KEY"), description="LLM API key")
    deepseek_api_base: str = Field(default=os.getenv("DEEPSEEK_API_BASE"), description="LLM API base")
    deepseek_api_model: str = Field(default=os.getenv("DEEPSEEK_API_MODEL"), description="LLM model name")
